export default `<!-- wp:group --><!-- wp:columns {"metadata":{"categories":["call-to-action"],"patternName":"three-column-pricing-table","name":"Three column pricing table"},"align":"wide","style":{"spacing":{"margin":{"bottom":"0"}}}} -->
...
<div class="wp-block-column has-text-color has-background has-link-color" style="color:#000000;background-color:#ffe97d;padding-top:2em;padding-right:2em;padding-bottom:2em;padding-left:2em"><!-- wp:heading {"style":{"typography":{"fontSize":"40px"}}} -->
...
<div class="wp-block-column has-text-color has-background has-link-color" style="color:#000000;background-color:#d1d1e1;padding-top:2em;padding-right:2em;padding-bottom:2em;padding-left:2em"><!-- wp:heading {"style":{"typography":{"fontSize":"40px"}}} -->
...
<!-- wp:buttons {"align":"full","layout":{"type":"flex","justifyContent":"center","orientation":"horizontal"}} -->
<div class="wp-block-buttons alignfull"><!-- wp:button {"textColor":"white","width":100,"className":"is-style-fill","style":{"color":{"background":"#000000"},"border":{"radius":0}}} -->
...
<div class="wp-block-column has-text-color has-background has-link-color" style="color:#000000;background-color:#c0ebf1;padding-top:2em;padding-right:2em;padding-bottom:2em;padding-left:2em"><!-- wp:heading {"style":{"typography":{"fontSize":"40px"}}} -->
...
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"extendable/footer-offset-heading-buttons","name":"Footer with offset heading and buttons (Primary)"},"align":"full","style":{"spacing":{"blockGap":"var:preset|spacing|40","padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|40"}}},"backgroundColor":"tertiary","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull has-tertiary-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0px","bottom":"1rem"}}}} -->
<h2 class="wp-block-heading has-text-align-center" style="margin-top:0px;margin-bottom:1rem">Let's Work Together</h2>
<!-- /wp:heading -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"right":"var:preset|spacing|30","left":"var:preset|spacing|30","top":"var:preset|spacing|30"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><!-- wp:group {"layout":{"type":"flex","allowOrientation":false}} -->
...
<!-- wp:social-links {"iconColor":"foreground","iconColorValue":"#0B0620","size":"has-normal-icon-size","className":"is-style-logos-only","style":{"spacing":{"blockGap":"1rem"}},"layout":{"type":"flex","justifyContent":"right"}} -->
...
<!-- wp:group {"metadata":{"categories":["gallery"],"patternName":"core/three-columns-with-images-and-text","name":"Three columns with images and text"},"align":"full","style":{"color":{"background":"#f5eac1"},"spacing":{"padding":{"top":"6vw","bottom":"6vw","left":"6vw","right":"6vw"}}},"layout":{"type":"default"}} -->
...
<!-- wp:cover {"overlayColor":"black","isUserOverlayColor":true,"minHeight":66,"minHeightUnit":"vh","metadata":{"categories":["text"],"patternName":"core/offset-bold-paragraph-text-with-varying-opacity","name":"Offset bold paragraph text with varying opacity"},"align":"full","style":{"spacing":{"padding":{"top":"4vw","right":"4vw","bottom":"4vw","left":"4vw"},"margin":{"top":"0"}}},"textColor":"white"} -->
...
<!-- wp:media-text {"align":"wide","mediaPosition":"right","mediaId":5263,"mediaLink":"https://wordpress.org/patterns/pattern/image-and-quote-on-a-background/pear-3/","mediaType":"image","verticalAlignment":"center","style":{"color":{"background":"#f1f5c7"}}} -->
...
<!-- wp:group {"metadata":{"categories":["call-to-action"],"patternName":"link-in-bio","name":"Link in Bio"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","right":"0","bottom":"var:preset|spacing|80","left":"0"}}},"backgroundColor":"white","layout":{"type":"default"}} -->
